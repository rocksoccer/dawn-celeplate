(function (window, k) {
    if (!window.AppstleIncluded && (!urlIsProductPage() || 'V1' === 'V2')) {
      ...
      appstleLoadScript("https://cdn.shopify.com/s/files/1/0654/7338/0587/t/6/assets/appstle-subscription.js?v=1683130227");
      ...
      RS.Config = {
        "selectors": {
            ...
            "subscriptionLinkSelector": "#shopify-section-template--16718750843115__main > div > div:nth-child(2) > div:nth-child(2)",
